...
class Move:
    ...
    def __repr__(self):
        ...
        if self.promotion_piece_type:
            ...
            result += piece_chars[self.promotion_piece_type]
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Move):
            return False
        return (
            self.from_rank == other.from_rank and
            self.from_file == other.from_file and
            self.to_rank == other.to_rank and
            self.to_file == other.to_file and
